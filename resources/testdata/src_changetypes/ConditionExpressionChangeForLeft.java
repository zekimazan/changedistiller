		...
		private int lowerLimit;
 		...
 		public void getPolynomial(){
			 ...
			 do{
	 			...
	 			for(int i=0; i<keyboard.length(); i++) //ConditionExpressionChangeForLeft.java and ConditionExpressionChangeForRight.java have difference in that line.
