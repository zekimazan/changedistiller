...
public class AddingMethodOverridabilityTest {
	List<SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("AddingMethodOverridability_Left.java", "AddingMethodOverridability_Right.java");
	}
	
	@Test
	public void classRenamingTest() {
		String expected = "ADDING_METHOD_OVERRIDABILITY\n";
