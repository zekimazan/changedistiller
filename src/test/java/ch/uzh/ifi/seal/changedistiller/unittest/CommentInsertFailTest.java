...
public class CommentInsertFailTest {
	List<SourceCodeChange> sourceCodeChangeList;

	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("CommentInsertFail_Left.java", "CommentInsertFail_Right.java");
	}

	@Test
	public void classRenamingTest() {
		String expected = "COMMENT_INSERT\n";
