...
public class DocDeleteTest {
	...
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("DocDelete_Left.java", "DocDelete_Right.java");
	}
	
	@Before
	public void setUp2() {
		sourceCodeChangeList2 = FileDistillerUtil.getChangesFromFile("DocDeleteFail_Left.java", "DocDeleteFail_Right.java");
	}
	
	@Test
	public void docDeleteTest() {
		String expected = "DOC_DELETE\n";
