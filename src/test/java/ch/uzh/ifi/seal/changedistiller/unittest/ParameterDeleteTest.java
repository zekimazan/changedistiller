...
public class ParameterDeleteTest {
	List<SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("ParameterDelete_Left.java", "ParameterDelete_Right.java");
	}
	
	@Test
	public void parameterDeleteTest() {
		String expected = "PARAMETER_DELETE\n";
