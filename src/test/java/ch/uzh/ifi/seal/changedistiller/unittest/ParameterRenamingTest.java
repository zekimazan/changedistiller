...
public class ParameterRenamingTest {
	List<SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("ParameterRenaming_Left.java", "ParameterRenaming_Right.java");
	}
	
	@Test
	public void classRenamingTest() {
		String expected = "PARAMETER_RENAMING\n";
