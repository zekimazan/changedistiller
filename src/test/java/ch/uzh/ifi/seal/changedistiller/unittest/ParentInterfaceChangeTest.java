...
public class ParentInterfaceChangeTest {
	List<SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("ParentInterfaceChange_Left.java", "ParentInterfaceChange_Right.java");
	}
