...
public class REMOVE_CLASS_TEST {
	List <SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("REMOVE_CLASS_LEFT.java", "REMOVE_CLASS_RIGHT.java");
	}
	
	@Test
	public void StatementOrderingChangeTest() {
		String expected = "REMOVED_CLASS\n";
