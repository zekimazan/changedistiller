...
public class StatementOrderingChangeTest {
	List<SourceCodeChange> sourceCodeChangeList;
	
	@Before
	public void setUp() {
		sourceCodeChangeList = FileDistillerUtil.getChangesFromFile("StatementOrderingChange_Left.java", "StatementOrderingChange_Right.java");
	}
	
	@Test
	public void StatementOrderingChangeTest() {
		String expected = "STATEMENT_ORDERING_CHANGE\n";
